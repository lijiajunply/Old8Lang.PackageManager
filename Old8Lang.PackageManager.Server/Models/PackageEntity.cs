...
public class PackageEntity
{
    ...
    [Required]
    [MaxLength(20)]
    public string Language { get; set; } = "old8lang";
    ...
    public virtual ICollection<PackageDependencyEntity> PackageDependencies { get; set; } = new List<PackageDependencyEntity>();
    public virtual ICollection<PackageFileEntity> Files { get; set; } = new List<PackageFileEntity>();
    public virtual ICollection<ExternalDependencyEntity> ExternalDependencies { get; set; } = new List<ExternalDependencyEntity>();
    public virtual ICollection<LanguageMetadataEntity> LanguageMetadata { get; set; } = new List<LanguageMetadataEntity>();
}
...
public class ApiKeyEntity
{
    ...
    [MaxLength(50)]
    public string Scopes { get; set; } = "package:read,package:write";
...
public class ExternalDependencyEntity
{
    ...
    [Required]
    [MaxLength(100)]
    public string DependencyType { get; set; } = string.Empty; // pip, conda, etc.
...
public class LanguageMetadataEntity
{
    ...
    [Required]
    [MaxLength(20)]
    public string Language { get; set; } = string.Empty; // old8lang, python
    
    [Required]
    [MaxLength(1000)]
    public string Metadata { get; set; } = string.Empty; // JSON 格式的特定元数据
